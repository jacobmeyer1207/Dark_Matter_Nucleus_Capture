...
class Detector:
    ...
    def random_entrance(self):
        ...
        if enter_face < self.area_x:     # Entering front or back face
            ...
            if self.uz < 0:
                ...
                self.y = rand.uniform(self.y_min, self.y_max)
                self.z = self.z_min
            # Returns velocity for main rates object
        return(v)
    ...
    def gen_capture_locs(self):
        ...
        distance_to_edge = self.particle_dist_from_det()
        if distance_to_edge < .01:
            print("failure:", distance_to_edge, "direction:", "position:", self.x, self.y, self.z,"direction:", self.ux, self.uy, self.uz)
    ...
    def photon_generation(self, event_num = 1):
        ...
        for location in self.capture_locs.keys():
            ...
            for i in range(10000000):
                ...
                if photon_energy > .1 and photon_energy < .12:
                    photon_energy_list_10_12.append(((n,l,new_n,new_l),photon_energy))
        ...
        return event, photon_energy_list_10_12
# Functions**********************************************************
