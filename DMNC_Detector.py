...
class Detector:
    ...
    def gen_capture_locs(self):
        ...
        for i in range(10000):
            ...
            # change this to probability calculation and select max p(l'<l) select before this point
            #l' = -1/n(pi) * log(1 - (1 - e^(-n(sigma)l)y)
            ...
            if self.particle_in_det():
                ...
                break
    #In the event that multiple captures are common, parallelize location loop.
